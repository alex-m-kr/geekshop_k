# Generated by Django 3.2.10 on 2022-01-08 09:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "short_desc",
                    models.CharField(blank=True, max_length=60, verbose_name="краткое описание продукта"),
                ),
                ("description", models.TextField(blank=True, verbose_name="описание продукта")),
                (
                    "price",
                    models.DecimalField(decimal_places=2, default=0, max_digits=8, verbose_name="цена продукта"),
                ),
                (
                    "quantity",
